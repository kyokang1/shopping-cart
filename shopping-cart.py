...
##
## Challenge - automated pytesting - product lookup
##
...
##
## Challenge - Separate the data from the source
##

#filepath = os.path.join(os.path.dirname(__file__), "..", "data", "shopping-cart-data.csv")
#
#with open(filepath, "r") as data:
#    products = csv.DictReader(data)
#
#
#print(filepath)
...
if __name__ == "__main__":
    ...
    print("K-YOUNG 'ALL-IN-ONE' GROCERY STORE") 
